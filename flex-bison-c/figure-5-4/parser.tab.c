...
{
  "\"end of file\"", "error", "\"invalid token\"", "DIGIT", "N", "'+'",
  "'*'", "'('", "')'", "$accept", "l", "e", "ep", "t", "tp", "f", YY_NULLPTR
};
...
{
       1,     8,     9,    14,     2,    10,     7,    17,    12,    15,
      18,     0,     0,     0,     0,    16
};

static const yytype_int8 yycheck[] =
{
       3,     0,     4,     8,     7,     5,     2,    15,     6,    10,
      16,    -1,    -1,    -1,    -1,    12
};
