...
#line 36 "parser.y"
                    {   
                        addType((yyvsp[0].id), (yyvsp[-2].type)); 
                        printf("addType('%s', '%s')\n", (yyvsp[0].id), (yyvsp[-2].type));
...
#line 41 "parser.y"
                    { 
                        addType((yyvsp[0].id), (yyvsp[-1].type));
                        printf("addType('%s', '%s')\n", (yyvsp[0].id), (yyvsp[-1].type));
