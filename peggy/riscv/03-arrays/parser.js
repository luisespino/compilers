...
function peg$parse(input, options) {
  ...
  var peg$f1 = function(type, variable, expression) {
  ...
  var peg$f2 = function(type, variable, value) {
  ...
  var peg$f7 = function(list) {
    	return list;
    };
  var peg$f8 = function(value, list) {
    	return [value].concat(list);
    };
  var peg$f9 = function(value) {
    	return [value];
    };
  var peg$f10 = function(varDest, varSrc, index) {
  ...
  var peg$f11 = function(value, index) {
