...
{
       0,    30,    30,    38,    44,   102,   205,   213,   222,   228,
     242
};
#endif
...
#line 44 "parser.y"
        ...
        switch ((yyvsp[0].attr).type) {
            case ADDR_INT:
                ...
                if (symbol_table_search((yyvsp[-2].str), &value)) {
                    code = strconcat(code,"\tldr X0, =");
                    code = strconcat(code,(yyvsp[-2].str));
                    code = strconcat(code,"\n");

                    code = strconcat(code,"\tmov X1, #");
                    char buffer[12];
                    value = *(int*)(yyvsp[0].attr).addr;
                    ...
                    data = strconcat(data, (yyvsp[-2].str));
            ...
            case ADDR_TMP:
                ...
                code = strconcat(code,(yyvsp[0].attr).addr);
                code = strconcat(code,"\n");
...
#line 102 "parser.y"
        ...
        data = strconcat(data, (yyval.attr).addr);
        data = strconcat(data, ": .word ");
        data = strconcat(data, "0");
        data = strconcat(data,"\n");                                        

        code = strconcat(code,"\tldr X0, =");
        code = strconcat(code,(yyval.attr).addr);
        code = strconcat(code,"\n");
        ...
        switch ((yyvsp[-2].attr).type) {
            ...
            case ADDR_TMP:
                switch ((yyvsp[0].attr).type) {
                    case ADDR_INT:
                        code = strconcat(code,"\tldr X1, =");
                        code = strconcat(code, (yyvsp[-2].attr).addr);
                        code = strconcat(code,"\n");
